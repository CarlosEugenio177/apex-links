...
import { IconType } from "../data/links"
...
export function renderIcon(iconKey: IconType) {
  switch (iconKey) {
    case "whatsapp":
    ...
    case "tiktok":
      return <TikTokIcon className="w-5 h-5 text-slate-900 dark:text-white" />
    default:
      return <LinkIcon className="w-5 h-5 text-slate-700 dark:text-neutral-300" />
  }
}
